...
// echo '</pre>';
	...
	/**
	 * Output specified content to the log file. 
	 ...
	 * are not assumed, so this can be multiple times to output a single line
	 * of content. 
	 * @param  string $string Text to output. 
	 */
...
// echo __METHOD__.__LINE__.' '.self::$Output.'<br/>';
	...
	/**
	 * Output content based on predefined settings. Decorate the output with 
	 * the source line, file, method, class it is called from. 
	 * 
